...
async function main() {
    ...
    const ugcShowings = await fetchPage("https://www.ugc.fr/showingsCinemaAjaxAction!getShowingsForCinemaPage.action?cinemaId=10");
    {
    ...
    const ugcSeances = await fetchPage("https://www.ugc.fr/showingsFilmAjaxAction!getShowingsByFilm.action?filmId=17381&cinemaId=10");
    {
    ...
    const allocinePage = await fetchPage("https://www.allocine.fr/seance/salle_gen_csalle=C0159.html");
    {
...
//# sourceMappingURL=debug-scrapers2.js.map