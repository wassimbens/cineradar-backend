...
async function main() {
    ...
    console.log("=== 1. UGC PAGE FILM ===");
    {
        ...
        await page.goto("https://www.ugc.fr/film_le_diable_s_habille_en_prada_2_17381.html", { waitUntil: "domcontentloaded", timeout: 30_000 });
    ...
    console.log("\n=== 2. AlloCiné RÉSEAU ===");
    {
        ...
        await page.goto("https://www.allocine.fr/seance/salle_gen_csalle=C0159.html", { waitUntil: "networkidle", timeout: 45_000 });
        ...
        $("[class]").each((_, el) => {
            ...
            cls.split(/\s+/).forEach(c => { if (c && c.length > 3 && c.length < 30)
                allClasses.add(c); });
        });
        const classArr = Array.from(allClasses).filter(c => c.includes("show") || c.includes("movie") || c.includes("film") || c.includes("hour") || c.includes("time") || c.includes("seance") || c.includes("card"));
...
//# sourceMappingURL=debug-scrapers3.js.map