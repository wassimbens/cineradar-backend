...
const POSTERS: Record<string, string | null> = {
  ...
  "Past Lives":
    "https://image.tmdb.org/t/p/w500/pHkKbIRoCe7zIFvqan9LqSo9bEm.jpg",
  "Poor Things":
    "https://image.tmdb.org/t/p/w500/mCR4F1aIUxSBjxO8C73oWTpY7KU.jpg",
  "Anatomie d'une chute":
    "https://image.tmdb.org/t/p/w500/tEjJGqEOJBJ2OtTsBKXtFxfJvZF.jpg",
...
async function main() {
  for (const [titre, affiche] of Object.entries(POSTERS)) {
    const film = await prisma.film.findFirst({ where: { titre } });
    if (!film) { console.log(`⚠️  Film introuvable : ${titre}`); continue; }
